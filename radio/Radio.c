...
#define axradio_phy_preamble_len  96
#define axradio_framing_synclen   32

#define axradio_phy_preamble_flags 0x38
#define axradio_phy_preamble_byte 0x7E
...
const uint16_t RegisterVaule[][2]=
{
        ...
        {REG_AX5043_MATCH1PAT1,          0x7E},
        {REG_AX5043_MATCH1PAT0,          0x7E},
        ...
        {REG_AX5043_TMGRXPREAMBLE2,      0x17},
...
//                            }
                        ...
                        case trxstate_tx_packet:    //9  trxstate_tx_packet
                            TransmitData();
                            break;
